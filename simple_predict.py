...
def main():
    ...
    parser.add_argument("-i", '--input_folder', help="Must contain all modalities for each patient in the correct"
                        ...
                        default='../nnUNet/nnUNet_raw_data_base/nnUNet_raw_data/Task216_AMOS2022_task1/imagesTs/') #Task027_ACDC Task017_AbdominalOrganSegmentation Task216_AMOS2022_task1
    parser.add_argument('-o', "--output_folder", required=False, help="folder for saving predictions",
                        default='../nnUnet/results_imageTs/output_task216_d07_best_new')
    ...
    parser.add_argument("--all_in_gpu", type=str, default="False", required=False, help="can be None, False or True. "
                                                                                       "Do not touch.")
    ...
    parser.add_argument('-chk',
                        ...
                        required=False,
                        default='model_final_checkpoint')  ## model_best
    parser.add_argument('--disable_mixed_precision', default=False, action='store_true', required=False,
                        help='Predictions are done with mixed precision by default. This improves speed and reduces '
                             'the required vram. If you want to disable mixed precision you can set this flag. Note '
                             'that this is not recommended (mixed precision is ~2x faster!)')
    parser.add_argument('--Tconv', type=str, required=False, default='shiftConvPP',
    ...
    args.chk = f"{args.Tconv}_{args.chk}"
    print(args.chk)
    ...
    # 输入nnUNet_raw_data，然后经过preprocessing，再进行predict
