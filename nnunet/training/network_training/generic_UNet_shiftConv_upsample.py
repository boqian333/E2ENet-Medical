    ...
    def __init__(self, img_size, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        for n in range(num_pool):
            if n == 0:
                ...
                self.fc3.append(
                    nn.Conv3d(input_resolution[n][0] // (input_resolution[n][0]//4) * input_resolution[n][1] // 2 * input_resolution[n][2] // 2 * self.S[n],
                              input_resolution[n][0] // (input_resolution[n][0]//4) * input_resolution[n][1] // 2 * input_resolution[n][2] // 2 * self.S[n], 1, first_stride,
