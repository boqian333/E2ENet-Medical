...
def add_sparse_args(parser):
    ...
    parser.add_argument('--sparse_init', type=str, default='ERK', help='sparse initialization: ERK, snip, Grasp')
    ...
    parser.add_argument('--update_frequency', type=int, default=1200, metavar='N', help='how many iterations to train between parameter exploration')
...
class Masking(object):
    ...
    def add_module(self, module, density, sparse_init='ER'):
        ...
        self.module = module
        # name_t_list = list(module.named_parameters())
        ...
        print('Removing norm...')
        self.remove_weight_partial_name('norm')
        print('Removing bias...')
        self.remove_weight_partial_name('bias')
        print('Removing 3D batch norms...')
        self.remove_type(nn.BatchNorm3d)
