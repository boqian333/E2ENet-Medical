...
if __name__ == "__main__":
    ...
    maybe_mkdir_p("/media/fabian/e2enet/Task035_ISBILesionSegmentation")
    save_pickle(splits, join("/media/fabian/e2enet/Task035_ISBILesionSegmentation", "splits_final.pkl"))
