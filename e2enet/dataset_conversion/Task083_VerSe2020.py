...
from e2enet.dataset_conversion.Task056_VerSe2019 import check_if_all_in_good_orientation, \
    print_unique_labels_and_their_volumes
from e2enet.paths import nnUNet_raw_data, preprocessing_output_dir
from e2enet.utilities.image_reorientation import reorient_all_images_in_folder_to_ras
...
if __name__ == "__main__":
    ### First we create a e2enet dataset from verse. After this the images will be all willy nilly in their
