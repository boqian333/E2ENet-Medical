...
import shutil
from e2enet.paths import default_cascade_trainer, default_plans_identifier, default_trainer, network_training_output_dir
...
def export_entry_point():
    ...
    parser.add_argument('-pl', type=str, help='e2enet plans identifier. Default: %s' % default_plans_identifier,
