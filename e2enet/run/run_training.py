...
from e2enet.training.network_training.nnUNetTrainerCascadeFullRes import nnUNetTrainerCascadeFullRes
from e2enet.training.network_training.nnUNetTrainerV2_CascadeFullRes import nnUNetTrainerV2CascadeFullRes
...
def main():
    ...
    parser.add_argument("--task", help="can be task name or task id", type=str, default='4')
    ...
    if trainer_class is None:
        raise RuntimeError("Could not find trainer class in e2enet.training.network_training")
