...
from e2enet.network_architecture.blocks import MLPBlock as Mlp
from e2enet.network_architecture.blocks import PatchEmbed, UnetOutBlock, UnetrBasicBlock, UnetrUpBlock
...
class SwinUNETR(SegmentationNetwork):
    ...
    def forward(self, x_in):
        ...
        return [logits1, logits2, logits3, logits4, logits5]  ## big to small
