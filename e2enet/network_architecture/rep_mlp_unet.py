...
class AxialShift(nn.Module):
    ...
    def __init__(self, dim, shift_size, as_bias=True, proj_drop=0., num_dim=3):
        ...
        if self.num_dim == 3:
            ...
            self.conv2_3 = nn.Conv3d(dim, dim, (3,3,3), 1, (1,1,1), groups=1, bias=as_bias) ## k=7:3; k=5:2; k=3:1;
            # self.conv2_1 = nn.Conv3d(dim, dim, (3, 1, 1), 1, (1, 0, 0), groups=1, bias=as_bias)
            # self.conv2_2 = nn.Conv3d(dim, dim, (1, 1, 3), 1, (0, 0, 1), groups=1, bias=as_bias)
            # self.conv2_3 = nn.Conv3d(dim, dim, (1, 3, 1), 1, (0, 1, 0), groups=1, bias=as_bias)
            ...
            self.shift_dim2 = torch_shift(self.shift_size, 2, 3)
    ...
    def forward(self, x):
        ...
        if len(x.shape) == 5:
            ...
            x_shift_d1d2 = self.shift_dim2(x)
