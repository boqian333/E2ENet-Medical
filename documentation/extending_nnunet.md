...
[here](../e2enet/experiment_planning/alternative_experiment_planning/normalization/experiment_planner_3DUNet_CT2.py)). 
...
An example is provided [here](../e2enet/preprocessing/preprocessing.py).
...
just like our implementation of the [Generic_UNet](../e2enet/network_architecture/generic_UNet.py). Furthermore, it must be
...
(see FabiansUNet in [generic_modular_residual_UNet.py](../e2enet/network_architecture/generic_modular_residual_UNet.py)). 
...
[ExperimentPlanner3DFabiansResUNet_v21](../e2enet/experiment_planning/alternative_experiment_planning/experiment_planner_residual_3DUNet_v21.py)
